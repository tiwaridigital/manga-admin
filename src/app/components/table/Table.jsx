...
export default function TableComponent({data}) {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      case 'name':
        return (
            <Link href={`https://man-iota.vercel.app/manga/${user.slug}`} target='_blank'>
      ...
      case 'createdAt':
        ...
        return (
          <div className='flex flex-col'>
            <p className='text-bold text-small capitalize'>{dateFormatter(user.createdAt)}</p>
          </div>
        )
      case 'status':
        return (
      ...
      case 'actions':
        return (
          <div className='relative flex justify-center items-center gap-2'>
            <Button size='sm' color="danger" variant="bordered" startContent={<UserIcon />}>
              Delete
            </Button>
            <Button size='sm' color="success" variant="bordered" startContent={<FiEdit2 />}>
              Edit
            </Button>
          </div>
        )
